    ...
    card.innerHTML = `
        ...
        <div class="booking-info">
            <div class="info-item">
                ...
                <div class="info-content">
                    ...
                    <div class="info-value">${booking.trainer ? booking.trainer.name : 'N/A'}</div>
                </div>
            </div>
            ...
            <div class="info-item">
                ...
                <div class="info-content">
                    ...
                    <div class="info-value">
                        ${booking.timeSlot ? `${booking.timeSlot.startTime} - ${booking.timeSlot.endTime}` : 'N/A'}
                    </div>
                </div>
            </div>
        </div>
        ...
        ${booking.cancelledReason ? `
            <div style="margin-top: 15px; padding: 15px; background: #f8d7da; border-radius: 10px; color: #721c24;">
                <strong>Lý do hủy:</strong> ${booking.cancelledReason}
            </div>
        ` : ''}
...
function cancelBooking(bookingId) {
    ...
    fetch(`${pageContext.request.contextPath}/api/schedule/bookings/${bookingId}/cancel`, {
        method: 'PUT'
    })
    .then(response => response.json())
    .then(result => {
