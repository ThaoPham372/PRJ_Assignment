...
<style>
  ...
  * {
  ...
  .chat-icon {
    ...
    bottom: 30px;
    right: 30px;
    background: linear-gradient(135deg, #ffde59 0%, #f4d03f 100%);
    padding: 18px 24px;
    border-radius: 50px;
    font-weight: 700;
    color: #000;
...
<section class="news">
  <div class="news-box">
    ...
    <div class="news-content">
      ...
      <p>
        Tham gia buổi khai trương và nhận ưu đãi hấp dẫn với trang thiết bị hiện
        đại và không gian tập luyện rộng rãi.
      </p>
    </div>
    <button
      class="see-more-btn"
  ...
  <div class="news-box">
    ...
    <div class="news-content">
      <h4>Khóa học Yoga</h4>
      <p>
        Cải thiện sức khỏe với lớp Yoga mỗi tuần, giúp bạn thư giãn và cân bằng
        cuộc sống.
      </p>
    </div>
    <button
  ...
  <div class="news-box">
    ...
    <div class="news-content">
      ...
      <p>
        Giảm cân hiệu quả cùng chuyên gia dinh dưỡng với phương pháp khoa học và
        an toàn.
      </p>
    </div>
    <button
...
<div class="tf-feedback">
  ...
  <div class="feedback">
    <div class="feedback-box active">
      ...
      <p>
        Nhờ GymFit tôi đã tự tin hơn và có sức khỏe tốt hơn! Huấn luyện viên rất
    ...
    <div class="feedback-box">
      <div class="feedback-header">
        <img
          ...
          referrerpolicy="no-referrer"
        />
        <div class="info"><b>Chị Linh</b>, 32 tuổi<br />1.5 năm tập GymFit</div>
      </div>
      <p>
        Dịch vụ tận tâm, HLV chuyên nghiệp, rất hài lòng với kết quả đạt được
    ...
    <div class="feedback-box">
      ...
      <p>
        Không khí phòng tập hiện đại, tạo động lực mỗi ngày. Thiết bị đầy đủ và
        chất lượng cao.
      </p>
    </div>
  </div>
...
<!-- CHAT ICON -->
<div class="chat-icon"><i class="fas fa-comments"></i> AI Chat</div>

<script>
  // Danh sách ảnh transformation before/after từ Unsplash
  const imgs = [
    'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=900&q=80',
    'https://images.unsplash.com/photo-1540497077202-7c8a3999166f?ixlib=rb-4.0.3&auto=format&fit=crop&w=900&q=80',
    'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?ixlib=rb-4.0.3&auto=format&fit=crop&w=900&q=80',
    'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?ixlib=rb-4.0.3&auto=format&fit=crop&w=900&q=80',
    'https://images.unsplash.com/photo-1506629905607-1a0b4b4b4b4b?ixlib=rb-4.0.3&auto=format&fit=crop&w=900&q=80',
    'https://images.unsplash.com/photo-1551698618-1dfe5d97d256?ixlib=rb-4.0.3&auto=format&fit=crop&w=900&q=80',
  ];
