...
public class ProductDao extends GenericDAO<Product> {
    ...
    // Note: findById(int) and findByIdOptional(int) are inherited from GenericDAO
     ...
     */
    public void decreaseStockBatch(Map<Integer, Integer> productQuantities) throws SQLException {
     ...
     * @throws SQLException if insufficient stock
     */
    public void decreaseStockBatchWithEntityManager(Map<Integer, Integer> productQuantities, jakarta.persistence.EntityManager sharedEm) throws SQLException {
     ...
     */
    public void decreaseStockBatch(Map<Integer, Integer> productQuantities, java.sql.Connection conn) throws SQLException {
