...
public interface NutritionService {
     ...
     */
    void addMeal(long memberId, long foodId, BigDecimal servings);
     ...
     */
    List<UserMeal> todayMeals(long memberId);
     ...
     */
    DailyIntakeDTO todayTotals(long memberId);
     ...
     */
    boolean deleteMeal(long memberId, long mealId);
     ...
     */
    List<UserMeal> getMealHistory(long memberId, int days);
     ...
     */
    java.util.Map<java.time.LocalDate, DailyIntakeDTO> getDailyTotalsHistory(long memberId, int days);
     ...
     */
    java.util.Optional<model.NutritionGoal> getNutritionGoal(long memberId);
     ...
     */
    List<UserMeal> getMealsByDate(long memberId, java.time.LocalDate date);
     ...
     * @return daily intake totals
     */
    DailyIntakeDTO getDailyTotalsByDate(long memberId, java.time.LocalDate date);
     ...
     */
    model.NutritionGoal calculateAndSaveNutritionGoal(long memberId, Float weight, Float height, Integer age, String gender, String goalType, String activityLevel);
}
