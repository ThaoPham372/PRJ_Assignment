...
public class NutritionServiceImpl implements NutritionService {
    ...
    @Override
    public void addMeal(long memberId, long foodId, BigDecimal servings) {
        // Validate inputs
        if (memberId <= 0) {
    ...
    @Override
    public List<UserMeal> todayMeals(long memberId) {
        if (memberId <= 0) {
            return Collections.emptyList();
        }
    ...
    @Override
    public DailyIntakeDTO todayTotals(long memberId) {
        if (memberId <= 0) {
    ...
    @Override
    public boolean deleteMeal(long memberId, long mealId) {
    ...
    @Override
    public List<UserMeal> getMealHistory(long memberId, int days) {
    ...
    @Override
    public java.util.Map<java.time.LocalDate, DailyIntakeDTO> getDailyTotalsHistory(long memberId, int days) {
        if (memberId <= 0 || days <= 0) {
    ...
    @Override
    public Optional<NutritionGoal> getNutritionGoal(long memberId) {
        if (memberId <= 0) {
    ...
    @Override
    public List<UserMeal> getMealsByDate(long memberId, LocalDate date) {
    ...
    @Override
    public DailyIntakeDTO getDailyTotalsByDate(long memberId, LocalDate date) {
        if (memberId <= 0 || date == null) {
            return new DailyIntakeDTO();
        }
    ...
    @Override
    public NutritionGoal calculateAndSaveNutritionGoal(long memberId, Float weight, Float height, Integer age, String gender, String goalType, String activityLevel) {
