...
public class NutritionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Long memberId = Long.valueOf(currentUser.getId());
     ...
     */
    private void showNutritionPage(HttpServletRequest request, HttpServletResponse response, Long memberId)
            throws ServletException, IOException {
     ...
     */
    private void showNutritionHistory(HttpServletRequest request, HttpServletResponse response, Long memberId)
            throws ServletException, IOException {
     ...
     */
    private void addMeal(HttpServletRequest request, HttpServletResponse response, Long memberId)
            throws ServletException, IOException {
     ...
     * Validates input and calls service layer
     */
    private void deleteMeal(HttpServletRequest request, HttpServletResponse response, Long memberId)
            throws ServletException, IOException {
