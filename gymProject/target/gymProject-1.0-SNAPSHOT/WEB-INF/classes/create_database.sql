-- =============================================
-- Stamina Gym Management System - Database Creation Script
-- SQL Server Version
-- =============================================

-- Drop existing database if exists
IF EXISTS (SELECT name FROM sys.databases WHERE name = 'Gym_Manager')
BEGIN
    ALTER DATABASE Gym_Manager SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE Gym_Manager;
END
GO
...
-- Insert default admin users (with simple password hash)
...
('customer', 'cust123', 'Demo Customer', 'customer@gym.com', 'member', 'active');

-- Insert sample coaches
INSERT INTO coaches (full_name, email, phone, specialization, experience_years, salary, status, rating, total_clients, sessions_per_week) VALUES
('Nguyễn Văn Nam', 'nam.nguyen@gym.com', '0901234567', 'Chuyên gia Bodybuilding', 5, 15000000, 'active', 5, 18, 12),
('Trần Thị Lan', 'lan.tran@gym.com', '0912345678', 'Yoga & Pilates Instructor', 3, 12000000, 'active', 4, 15, 10),
('Lê Hoàng Minh', 'minh.le@gym.com', '0923456789', 'Strength & Conditioning', 7, 18000000, 'active', 5, 22, 15),
('Phạm Thu Hà', 'ha.pham@gym.com', '0934567890', 'Nutritionist & Fitness', 4, 13000000, 'active', 4, 16, 8);

-- Insert sample equipment
INSERT INTO equipment (name, category, manufacturer, model, location, status, purchase_price, warranty_months) VALUES
('Máy Chạy Bộ TechnoGym', 'Cardio', 'TechnoGym', 'Run Artis', 'Khu Cardio', 'working', 45000000, 24),
('Xe Đạp Tập Life Fitness', 'Cardio', 'Life Fitness', 'IC7', 'Khu Cardio', 'working', 35000000, 24),
('Máy Tạ Đa Năng Hammer', 'Strength', 'Hammer Strength', 'Pro 3', 'Khu Tạ', 'working', 85000000, 36),
('Ghế Tập Cơ Bụng', 'Strength', 'Body-Solid', 'AB-300', 'Khu Tạ', 'working', 25000000, 12),
('Bộ Tạ Đơn (5-50kg)', 'Phụ kiện', 'York', 'Olympic Set', 'Khu Tạ', 'working', 15000000, 12),
('Máy Rowing Concept2', 'Cardio', 'Concept2', 'Model D', 'Khu Cardio', 'maintenance', 40000000, 24),
('Cable Machine Multi-Function', 'Strength', 'Cybex', 'VR3', 'Khu Tạ', 'working', 65000000, 36),
('Dumbbell Set', 'Phụ kiện', 'Powerblock', 'Sport 50', 'Khu Tạ', 'working', 12000000, 12);
...
INSERT INTO transactions (transaction_code, customer_name, items, total_amount, final_amount, payment_method, transaction_date) VALUES
('TXN1001', 'Nguyễn Văn A', 'Premium Membership', 500000, 550000, 'cash', GETDATE()),
('TXN1002', 'Trần Thị B', '5 Buổi PT', 950000, 1045000, 'card', GETDATE()),
('TXN1003', 'Lê Văn C', 'Protein Powder', 1000000, 1100000, 'bank', GETDATE()),
('TXN1004', 'Phạm Thị D', 'VIP Membership', 800000, 880000, 'cash', GETDATE()),
('TXN1005', 'Khách vãng lai', 'Energy Drink x2', 50000, 55000, 'cash', GETDATE());

-- =============================================
-- Verify Database Creation
-- =============================================

PRINT 'Database Gym_Manager created successfully!';
PRINT 'Tables created: users, coaches, equipment, membership_packages, transactions, payment_schedules, training_sessions, maintenance_records, system_settings';
PRINT 'Default data inserted successfully!';
PRINT 'Test accounts created:';
PRINT '  - admin/admin123 (Admin)';
PRINT '  - manager/manager123 (Manager)';
PRINT '  - employee/emp123 (Employee)';
PRINT '  - customer/cust123 (Member)';
