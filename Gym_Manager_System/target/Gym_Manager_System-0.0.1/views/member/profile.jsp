...
<style>
    ...
    .stat-icon.workout { background: rgba(40, 167, 69, 0.1); color: var(--success); }
    .stat-icon.streak { background: rgba(255, 193, 7, 0.1); color: var(--warning); }
    .stat-icon.calories { background: rgba(220, 53, 69, 0.1); color: var(--danger); }
    .stat-icon.membership { background: rgba(236, 139, 94, 0.1); color: var(--accent); }
    ...
    .bmi-indicator.underweight { background: rgba(23, 162, 184, 0.1); color: var(--info); }
    .bmi-indicator.normal { background: rgba(40, 167, 69, 0.1); color: var(--success); }
    .bmi-indicator.overweight { background: rgba(255, 193, 7, 0.1); color: var(--warning); }
    .bmi-indicator.obese { background: rgba(220, 53, 69, 0.1); color: var(--danger); }
