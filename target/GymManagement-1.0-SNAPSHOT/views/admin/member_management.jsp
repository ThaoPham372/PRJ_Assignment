                                ...
                                <tbody>
                                    <c:forEach var="membership" items="${memberships}">
                                        <tr>
                                            ...
                                            <td>${membership.email}<br /><small>${membership.phone}</small></td>
                                            <td><span class="badge badge-pt">${membership.packageType}</span></td>
                                            <td>${membership.createdDate}</td>
                                            <td>${membership.endDate}</td>
                                            <td><span class="badge badge-active">${membership.status}</span></td>
                                            <td>
                                                <div class="action-buttons">
                                                    ...
                                                    <button class="btn-icon btn-delete" title="Xóa" onclick="deleteMembership(${membership.membershipId})">
...
<!--                                    <tr>
                    ...
                    <form action="#" method="post" id="membershipForm">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-input" name="package_id" required>
                                ...
                                <option value="1">Gói Basic (1 tháng - 500K)</option>
                                <option value="5">Gói Off-peak (3 tháng - 1.2M)</option>
                                <option value="7">Gói Premium (6 tháng - 25M)</option>
                                <option value="9">Gói VIP (12 tháng - 42M)</option>
                            </select>
                        </div>
            ...
            <script>
                ...
                function openAddMembershipModal() {
                    ...
                    form.action = `${contextPath}/admin/member-management`;
                    form.method = 'post';
